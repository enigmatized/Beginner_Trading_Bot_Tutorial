class Predictor:
    ...
    def hold_percent(self):
        if self.counterblocker>120:
            if (not self.features[3].positive_momentum_n_time(True, 3)) and (self.features[1].get_value() < 9350):
                currentBuyPrice = self.features[1].get_value()
            ...
            else:###This is my first positive money making strategy,  but this is far from ideal. I am only make 0.001%, I want to bump this i up to more.
                return ("Do Nothing", 0, 0)
        else:
