    ...
    def run(self):
        ...
        while True:
            ...
            for holding in self.ledgarOfHoldTillGain:
                valueUSDofPastPurchaseInNowTerms = (self.features[self.sellPrice].get_value() * holding["AmountBought"])
                percentageIwantToMake=0.007
            ...
            if actionHoldTillGain == "buy" and self.balanceTillGain>300 and ((self.lastPurchaseTime + timedelta(hours=12)) < now):
            ...
            print("Holding: ", self.holding,"Holding till Gain", self.holdingTillGain)
            print("Balance", self.balance,  "Balance till gain", self.balanceTillGain)
